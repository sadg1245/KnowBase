...
export const KnowledgePointManager = ({ points, onUpdate, onDelete, onMerge, onCard, onQuiz }: {
  ...
  return <div>
    <Button disabled={selected.length < 2} onClick={merge} style={{ marginBottom: 12 }}>合并选中的知识点</Button>
